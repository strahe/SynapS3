...
func init() {
	Migrations.MustRegister(up2026081901BucketMinimumDurableCopies, down2026081901BucketMinimumDurableCopies)
}

func up2026081901BucketMinimumDurableCopies(ctx context.Context, db *bun.DB) error {
...
func down2026081901BucketMinimumDurableCopies(ctx context.Context, db *bun.DB) error {
