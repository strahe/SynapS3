...
func TestFieldMetadataDefinesEnvMappings(t *testing.T) {
	...
	tests := []struct {
		...
		{env: "SYNAPS3_FILECOIN_AVAILABILITY_INTERVAL", field: "filecoin.availability.interval"},
		{env: "SYNAPS3_FILECOIN_AVAILABILITY_TIMEOUT", field: "filecoin.availability.timeout"},
		{env: "SYNAPS3_FILECOIN_AVAILABILITY_CONCURRENCY", field: "filecoin.availability.concurrency"},
