...
test('pipeline rows use task types and the five-state active breakdown', () => {
  const rows = overviewPipelineRows([
    { operation: 'storage_pull', total: 5, by_status: { pending: 2, running: 3 } },
    { operation: 'upload_plan', total: 1, by_status: { running: 1 } },
  ])
